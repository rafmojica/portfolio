...
import rafa_portrait from "../assets/rafa_portrait.jpg"
  ...
  return (
    <div
      style={{
        ...
        background:
          "radial-gradient(130% 100% at 50% -10%, #23414c 0%, #162a32 42%, #0d1a20 78%, #091015 100%)",
        paddingBottom: 36,
      }}
    >
      {/* Top glow */}
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(closest-side, rgba(243,196,90,.18), rgba(243,196,90,0) 70%)",
          filter: "blur(8px)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(120% 80% at 50% 120%, rgba(0,0,0,.55), rgba(0,0,0,0) 60%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background: "#f3c45a",
          boxShadow: "0 0 8px 2px rgba(243,196,90,.5)",
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background: "#7fd0d8",
          boxShadow: "0 0 8px 2px rgba(127,208,216,.5)",
        ...
        <div style={{ textAlign: "center", marginBottom: 26 }}>
          ...
          <h1
            style={{
              ...
              letterSpacing: "1px",
              background:
                "linear-gradient(180deg, #ffe6a0 6%, #f3c45a 48%, #d99a2c 100%)",
              WebkitBackgroundClip: "text",
              backgroundClip: "text",
              color: "transparent",
              filter:
                "drop-shadow(0 3px 0 rgba(60,40,8,.55)) drop-shadow(0 6px 10px rgba(0,0,0,.55))",
            }}
          >
            About
          </h1>
          <div
            style={{
              ...
              margin: "12px auto 0",
              background:
                "linear-gradient(90deg, transparent, #f3c45a, transparent)",
              borderRadius: 2,
            }}
          />
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  overflow: "hidden",
                  background:
                    "linear-gradient(135deg, rgba(30,56,66,.7), rgba(10,24,32,.85))",
            ...
            >
              ...
              />
              <span
                style={{ font: "500 13px 'Kreon', serif", color: "#cdb98f" }}
              >
                Berkeley, CA
              </span>
            </div>
            ...
            <div
              style={{
                ...
                margin: "16px 0 14px",
                background:
                  "linear-gradient(90deg, transparent, rgba(243,196,90,.4), transparent)",
              }}
            />
          ...
          <div
            style={{
              ...
              flexDirection: "column",
              background:
                "linear-gradient(162deg, rgba(30,56,66,.94), rgba(17,34,41,.96))",
              border: "1px solid rgba(150,190,200,.18)",
              borderRadius: 5,
              boxShadow:
                "0 22px 50px rgba(0,0,0,.5), inset 0 1px 0 rgba(255,255,255,.05)",
              padding: "28px 32px",
            }}
          >
            <div
            ...
            >
              {["Full-Stack", "Java · Python · TS", "Always Climbing"].map(
                (chip) => (
                  <span
                    key={chip}
                    style={{
            ...
            <div
              style={{
                marginTop: 20,
                paddingTop: 16,
                borderTop: "1px solid rgba(150,190,200,.14)",
                display: "flex",
                alignItems: "center",
                gap: 11,
              }}
            >
              ...
              />
              <span
                style={{ font: "500 13px 'Kreon', serif", color: "#9fc0c6" }}
              >
                Currently seeking the next floor. Internships &amp;
